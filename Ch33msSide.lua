-- Ch33msGUI Loadstring Version
-- Feito pro Enzo

print("🔥 Ch33msGUI carregada via loadstring!")

local player = game.Players.LocalPlayer
local screenGui = Instance.new("ScreenGui")
screenGui.Name = "Ch33msGUI"
screenGui.ResetOnSpawn = false
screenGui.Parent = player:WaitForChild("PlayerGui")

-- Frame Principal
local main = Instance.new("Frame")
main.Size = UDim2.new(0.68, 0, 0.78, 0)
main.Position = UDim2.new(0.16, 0, 0.11, 0)
main.BackgroundColor3 = Color3.fromRGB(13, 13, 26)
